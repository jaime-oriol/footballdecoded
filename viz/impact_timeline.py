"""Impact timeline showing decisive moments (goals, assists, dribbles) by minute.

Two-row timeline (first/second half). Events colored by match context
(winning/drawing/losing) and sized by temporal importance (last 15 min larger).
"""
...
def plot_impact_timeline(csv_path, player_name, face_path=None, team_name=None,
    ...
    """Plot impact timeline with events on two half-row timelines.

    Args:
        csv_path: CSV with minute, event_type, score_context columns.
    ...
    for _, event in events_df.iterrows():
        ...
        # Larger markers for clutch time (75+ min)
